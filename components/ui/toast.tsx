...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "inline-flex h-8 shrink-0 items-center justify-center rounded-md border bg-transparent px-3 text-sm font-medium ring-offset-background transition-colors hover:bg-secondary focus:outline-none focus:visible:ring-2 focus:visible:ring-ring focus:visible:ring-offset-2 disabled:pointer-events-none",
      className
    )}
    {...props}
  />
